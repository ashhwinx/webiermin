...
// --- UPDATED COMPONENT HERE ---
const SocialLink = ({ href, icon, label }: SocialLinkProps) => (
  <a 
    href={href} 
    // Ye line nayi tab mein open karegi
    target="_blank" 
    // Ye security ke liye zaroori hai jab target="_blank" use karte hain
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto border-t border-black/10 pt-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
          ...
          <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-8">
                  ...
                  <SocialLink href="https://www.instagram.com/webier.in/" icon={<Instagram size={20} />} label="Instagram" />
                  <SocialLink href="https://www.linkedin.com/company/webierdev/" icon={<Linkedin size={20} />} label="LinkedIn" />
              </div>
          </div>
